...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name, ['package.xml', 'localization/params.yaml', 'localization/test/test_params.yaml', 'localization/real_params.yaml', 'localization/rosbag_params.yaml']),
